      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <a
              href="https://www.linkedin.com/in/alnoor-for-export-and-food-industries-235332401"
              target="_blank"
              rel="noopener noreferrer"
              className="reveal flex items-center gap-4 bg-white hover:bg-sky-50 rounded-xl p-5 border border-border transition-colors duration-200 group"
            >
              ...
              <div>
                <div className="font-semibold text-sky-800 group-hover:text-sky-900">LinkedIn</div>
                <div className="text-sm text-sky-700">{isAr ? "تابعنا على لينكد إن" : "Follow us on LinkedIn"}</div>
              </div>
            </a>
          </div>
