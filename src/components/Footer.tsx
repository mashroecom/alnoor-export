...
export default function Footer() {
  ...
  return (
    <footer
      className={`bg-surface-dark ${isAr ? "font-ar" : ""}`}
      dir={t.dir}
    >
      <div className="max-w-7xl mx-auto px-5 sm:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-semibold text-sm text-white uppercase tracking-wider mb-5">{t.footer.quickLinks}</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-semibold text-sm text-white uppercase tracking-wider mb-5">{t.footer.contactInfo}</h4>
